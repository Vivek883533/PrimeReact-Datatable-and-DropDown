...
const App: FC = () => {
  ...
  useEffect(() => {
    axios.get('http://saawree.binateit.local/api/v1/admin/countries/country-list', {
      params: { tenatId },
    })
      .then(response => {
  ...
  useEffect(() => {
    axios.get('http://saawree.binateit.local/api/v1/admin/states/state-list', {
      params: { tenatId },
    })
      .then(response => {
  ...
  useEffect(() => {
    if (selectedCountry) {
      axios.post('http://saawree.binateit.local/api/v1/admin/states/state-list', { tenatId, countryId: selectedCountry.id })
        .then(response => {
